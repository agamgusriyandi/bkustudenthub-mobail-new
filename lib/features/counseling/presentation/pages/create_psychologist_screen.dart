...
class CreatePsychologistScreen extends StatefulWidget {
  const CreatePsychologistScreen({super.key});

  @override
  State<CreatePsychologistScreen> createState() =>
      _CreatePsychologistScreenState();
}

class _CreatePsychologistScreenState extends State<CreatePsychologistScreen> {
  ...
  Future<void> _save() async {
    ...
    final success =
        await context.read<AdminPsychologistProvider>().createPsychologist(data);
    if (!mounted) return;
