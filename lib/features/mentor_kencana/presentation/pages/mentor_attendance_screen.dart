...
class _MentorAttendanceScreenState extends State<MentorAttendanceScreen>
  ...
  final TextEditingController _absenceSearchController =
      TextEditingController();
      ...
      builder:
          (ctx) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(
                  'Mahasiswa: ${req.studentName} (${req.nim})',
  ...
  Widget build(BuildContext context) {
    ...
    final filteredAbsences =
        absenceRequests.where((a) {
          if (_absenceSearch.isNotEmpty) {
            final q = _absenceSearch.toLowerCase();
            if (!a.studentName.toLowerCase().contains(q) &&
                !a.sessionTitle.toLowerCase().contains(q)) {
              return false;
            }
          }
        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            BkuAppBar(
              ...
              info:
                  'Lihat dan validasi persentase kehadiran mahasiswa bimbingan Anda.',
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Menampilkan daftar sesi yang terdaftar.',
                                      style: AppTextStyles.labelSm.copyWith(
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildBuilderDelegate((context, index) {
                          ...
                          final isPending =
                              statusLower == 'permission_requested' ||
                              statusLower == 'pending' ||
                              statusLower == 'menunggu';
                          final isApproved =
                              statusLower == 'permission' ||
